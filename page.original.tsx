    ...
    <section style={{ position: 'relative', overflow: 'hidden', paddingTop: 100, paddingBottom: 80, textAlign: 'center' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px', position: 'relative' }}>
        <div style={{
          ...
          {isPro ? '✓ Pro — Full Access' : 'AI-Powered YouTube Growth'}
        </div>
        <h1 style={{
        ...
        <p style={{ fontSize: 18, color: 'var(--muted)', lineHeight: 1.7, maxWidth: 540, margin: '0 auto 48px', fontWeight: 400 }}>
          Paste any YouTube channel URL. Zenify analyzes top-performing videos and generates 5 AI-powered ideas ranked by predicted performance — complete with titles and thumbnail concepts.
        </p>
...
function Features() {
  const items = [
    ...
    },
    {
      ...
      desc: "Claude AI analyzes your channel's winning formula and generates 5 ranked video ideas — each one calibrated to replicate your top performers.",
    },
    {
      icon: '🖼️',
    ...
    <section id="features" style={{ padding: '80px 24px', maxWidth: 1120, margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: 56 }}>
        ...
        <p style={{ fontSize: 17, color: 'var(--muted)', maxWidth: 480, margin: '0 auto' }}>
          Stop guessing what to post. Let data and AI do the thinking.
        </p>
      </div>
...
function HowItWorks() {
  const steps = [
    ...
    { n: '03', title: 'Get 5 Ranked Ideas', desc: 'Claude AI generates 5 video ideas ranked by predicted performance, each with a title and thumbnail concept.' },
  ]
