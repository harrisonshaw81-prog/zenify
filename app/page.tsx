...
function Testimonials() {
  const all: TCard[] = [
    { type: 'face', avatar: 'MR', avatarBg: '', pfp: '/pfp/pfp01.png', name: 'Marcus R.', handle: '@marcusbuilds', subs: '84K subs', quote: "HypeCTR gave me 5 ideas in 30 seconds that would've taken me an afternoon. Three hit the top 10% of my channel." },
    { type: 'logo', avatar: 'SL', avatarBg: '', pfp: '/pfp/pfp02.png', name: 'Sophie L.', handle: '@sophielearns', subs: '210K subs', quote: "The thumbnail concepts alone are worth it. Paste the output to my designer and we're done in minutes." },
    { type: 'face', avatar: 'JT', avatarBg: '', pfp: '/pfp/pfp03.png', name: 'James T.', handle: '@jamestechreviews', subs: '47K subs', quote: "The analysis picked up a hook pattern in my top videos I hadn't noticed myself. Immediately actionable." },
    { type: 'logo', avatar: 'CM', avatarBg: '', pfp: '/pfp/pfp04.png', name: 'Chris M.', handle: '@chrismoneytalks', subs: '156K subs', quote: "The ranked list is the best part. I know exactly which idea to execute first, no second-guessing." },
    { type: 'face', avatar: 'AN', avatarBg: '', pfp: '/pfp/pfp05.png', name: 'Aisha N.', handle: '@aishalifts', subs: '22K subs', quote: "My last three videos all hit 50K+ views. HypeCTR changed the way I approach content planning entirely." },
    { type: 'logo', avatar: 'TB', avatarBg: '', pfp: '/pfp/pfp06.png', name: 'Tom B.', handle: '@tombuildsstuff', subs: '89K subs', quote: "I run it every Monday before planning the week. The workflow difference is massive." },
    { type: 'face', avatar: 'L',  avatarBg: '', pfp: '/pfp/pfp07.png', name: 'Lena S.', handle: '@lenastudio', subs: '44K subs', quote: "It found my hook formula before I did. That pattern recognition alone is worth the subscription." },
    { type: 'logo', avatar: 'RJ', avatarBg: '', pfp: '/pfp/pfp08.png', name: 'Ryan J.', handle: '@ryanjourneys', subs: '302K subs', quote: "Saved me 3 hours of research per video. I tracked it. That's not marketing copy." },
    { type: 'face', avatar: 'PK', avatarBg: '', pfp: '/pfp/pfp09.png', name: 'Priya K.', handle: '@priyacooks', subs: '31K subs', quote: "Went from posting once a month to twice a week. The ideas never dry up with HypeCTR." },
    { type: 'logo', avatar: 'MW', avatarBg: '', pfp: '/pfp/pfp10.png', name: 'Mei W.', handle: '@meiwanders', subs: '18K subs', quote: "As a new creator this gave me a roadmap I didn't know I needed. Wish I'd found it sooner." },
    { type: 'face', avatar: 'D',  avatarBg: '', pfp: '/pfp/pfp11.png', name: 'David P.', handle: '@davidspreneur', subs: '67K subs', quote: "I've tried other tools. None of them go this deep on actual channel data." },
    { type: 'logo', avatar: 'ZH', avatarBg: '', pfp: '/pfp/pfp12.png', name: 'Zara H.', handle: '@zarahealthtips', subs: '129K subs', quote: "The performance predictions are scary accurate. I trust them more than my own instincts now." },
    { type: 'face', avatar: 'NC', avatarBg: '', pfp: '/pfp/pfp13.png', name: 'Noah C.', handle: '@noahcodes', subs: '11K subs', quote: "Worth every dollar just for the thumbnail concepts. I'd honestly pay twice." },
    { type: 'logo', avatar: 'EB', avatarBg: '', pfp: '/pfp/pfp14.png', name: 'Elena B.', handle: '@elenabeauty', subs: '241K subs', quote: "HypeCTR helped me find a niche angle I'd completely overlooked in my own channel for two years." },
    { type: 'face', avatar: 'SK', avatarBg: '', pfp: '/pfp/pfp15.png', name: 'Sam K.', handle: '@samkitchen', subs: '78K subs', quote: "I analyze every channel I admire. It's like reverse-engineering success at scale." },
    { type: 'logo', avatar: 'FO', avatarBg: '', pfp: '/pfp/pfp16.png', name: 'Fatima O.', handle: '@fatimafit', subs: '35K subs', quote: "Went from 3K to 35K in 6 months. I credit HypeCTR for finding the content gaps I was missing." },
    { type: 'face', avatar: 'LT', avatarBg: '', pfp: '/pfp/pfp17.png', name: 'Luke T.', handle: '@luketravels', subs: '93K subs', quote: "The time savings alone justify the subscription. The results are just a bonus." },
    { type: 'logo', avatar: 'AJ', avatarBg: '', pfp: '/pfp/pfp18.png', name: 'Amara J.', handle: '@amarajournals', subs: '56K subs', quote: "My editor asks why my briefs have gotten so much better. I just smile." },
    { type: 'face', avatar: 'B',  avatarBg: '', pfp: '/pfp/pfp19.png', name: 'Ben R.', handle: '@benreviews', subs: '188K subs', quote: "Five ranked ideas with scoring logic. No decision fatigue. Just execute." },
    { type: 'logo', avatar: 'YM', avatarBg: '', pfp: '/pfp/pfp20.png', name: 'Yuki M.', handle: '@yukiminimalist', subs: '29K subs', quote: "Sent this to every creator I know. That's the best testimonial I can give." },
  ]
